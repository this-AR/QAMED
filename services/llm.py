        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "If the question is a simple definition or single-concept query, return it as a single question — do NOT split it. "
                    "Return only a numbered list. Maximum 3 subquestions. Do not add explanations.\n\n"
                    "Example 1:\n"
